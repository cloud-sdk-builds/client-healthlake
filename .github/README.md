...
[`@aws-sdk/client-healthlake`](https://www.npmjs.com/package/@aws-sdk/client-healthlake/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-healthlake@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wbwU+hRVM+LWK5n4ROIlmDQ8ZuJklivMw6obb++XRuHNfcoDdj8Dpqdm6W3NKa0x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-healthlake": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-healthlake@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-healthlake@3.887.0/index.min.mjs": "sha384-wbwU+hRVM+LWK5n4ROIlmDQ8ZuJklivMw6obb++XRuHNfcoDdj8Dpqdm6W3NKa0x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-healthlake/blob/refs/tags/3.887.0/LICENSE
```
